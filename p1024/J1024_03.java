...
public class J1024_03 {
	...
	public static void main(String[] args) {
		...
		d2 = 100000/3.0; // 둘 중 하나를 double로 만들면 3.333333 나옴. 그 대신 double이니까 15자리까지만 정확하게.
		...
		char c4 = (char)(c1 - 32); //소문자를 대문자로 바꿀 때
		System.out.println(c4);
		
		char c5 = 'A';
		System.out.println((char)(c5+32)); //대문자를 소문자로 바꿀 때
