		...
		while (true) {
			...
			if (input.equals("Y") || input.equals("y")) {
				...
				if (userId.equals("ryu") && userPw.equals("1234")) {
					...
					// 류승택님 로그인
					Member ryu = new Member("ryu", "류승택", 50000000, 0);
					// 온라인구매부분
					while (true) {
						System.out.println("\n[ 현대자동차 구로디지털 온라인지점 ]");
						System.out.println("인기 차량 빅세일");
						...
						case 5:
							...
							System.out.printf("현재 포인트 : %,d %n", ryu.bonusPoint);
							break;
						case 7:
							System.out.printf("현재 잔액 : %,d %n\n", ryu.money);
							System.out.println("충전금액을 입력하세요 >>");
							choice = scan.nextInt();
							ryu.money += choice;
							System.out.println(choice + "원 충전이 완료됐습니다.");
							System.out.printf("현재 보유금액 : %,d %n\n", ryu.money);
							break;
						case 8:
